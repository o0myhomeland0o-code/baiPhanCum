...
# Hàm hiển thị cả % và số lượng SV
def hien_thi_phan_tram(pct):
    total = sum(counts)
...
# Tiêu đề
ax.set_title(
    'Biểu đồ tròn thống kê phân loại sinh viên',
    fontsize=16,
    fontweight='bold',
    pad=20
)

# Đảm bảo hình tròn đều
ax.axis('equal')

plt.tight_layout()

# Lưu ảnh
chart_path = 'bieu_do_thong_ke.png'
